...
import '../register_user_page/register_user_page_widget.dart';
...
class _SignUpPageWidgetState extends State<SignUpPageWidget> {
  ...
  void initState() {
    ...
    confirmfieldController = TextEditingController();
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(2, 2, 2, 2),
                      child: TextFormField(
                        controller: confirmfieldController,
                        obscureText: !confirmfieldVisibility,
                        decoration: InputDecoration(
                          labelText: 'パスワードを確認',
                          labelStyle: FlutterFlowTheme.of(context).bodyText2,
                          hintStyle: FlutterFlowTheme.of(context).bodyText2,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ToggleIcon(
                        onPressed: () async {
                          setState(
                              () => FFAppState().state = !FFAppState().state);
                        },
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          if (FFAppState().state != true) {
                            var confirmDialogResponse = await showDialog<bool>(
                                  context: context,
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('同意'),
                                      content: Text('規約に同意しますか？'),
                                      actions: [
                                        TextButton(
